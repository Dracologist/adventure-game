...
<?php if (strlen('weightywordbridge') > (strlen($SESSION['player']->getFname()) + strlen($SESSION['player']->getLname()))): ?>
...
" ?>
        ...
        than the ropes could handle. You plummet into the darkness of the</p>
